namespace ClinicaIF.Models
{
    ...
    public partial class tbProfissional
    {
        ...
        public tbProfissional()
        {
            ...
            tbPerguntas = new HashSet<tbPergunta>();
            tbReceitaAlimentarPadraos = new HashSet<tbReceitaAlimentarPadrao>();
            tbReceitaMedicaPadraos = new HashSet<tbReceitaMedicaPadrao>();
        }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<tbPergunta> tbPerguntas { get; set; }

        public virtual tbTipoAcesso tbTipoAcesso { get; set; }

        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<tbReceitaAlimentarPadrao> tbReceitaAlimentarPadraos { get; set; }

        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<tbReceitaMedicaPadrao> tbReceitaMedicaPadraos { get; set; }
    }
}
